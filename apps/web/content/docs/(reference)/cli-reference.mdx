...
- `--ip <ip/cidr>`: Restrict access to specific IP addresses or CIDR ranges (can be used multiple times).
...
- `ip_allowlist`: List of allowed IPs or CIDR ranges (optional, e.g., `["1.2.3.4", "10.0.0.0/8"]`)

        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">
              Integrate with any
              <br />
              <span className="text-white/50">Vite application</span>
            </h2>
            <p className="text-lg text-white/40 leading-relaxed mb-8">
              Whether you're building a web app with React, a real-time service with Vue,
              a desktop app with Svelte, or a command-line tool with SolidJS, 
              OutRay seamlessly integrates into your stack.
            </p>
          ...
          >
            <div className="bg-white/5 border-b border-white/5 px-4 py-3 flex items-center gap-2">
              ...
              <span className="text-xs text-white/40 ml-2">vite.config.ts</span>
            </div>
            <div className="p-6 font-mono text-sm overflow-x-auto">
              <pre className="text-white/70">
                <code>
                  <span className="text-accent">import</span> {"{"} defineConfig {"}"}{" "}
                  <span className="text-accent">from</span>{" "}
                  <span className="text-green-400/80">'vite'</span>;{"\n"}
                  <span className="text-accent">import</span> react{" "}
                  <span className="text-accent">from</span>{" "}
                  <span className="text-green-400/80">'@vitejs/plugin-react'</span>;{"\n"}
            ...
            <div className="border-t border-white/5 p-6 bg-black/30">
              <div className="font-mono text-sm space-y-1">
                ...
                <p className="text-white/50 mt-3">
                  ...
                  <span className="text-accent">http://localhost:5173/</span>
                </p>

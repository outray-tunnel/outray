      ...
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-white font-semibold mb-1 text-sm sm:text-base">mDNS Discovery</h3>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-white font-semibold mb-1 text-sm sm:text-base">Trusted HTTPS</h3>
              <p className="text-white/40 text-xs sm:text-sm">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-white font-semibold mb-1 text-sm sm:text-base">Zero Config</h3>
              <p className="text-white/40 text-xs sm:text-sm">
        ...
        <div className="relative group mt-8 lg:mt-0">
          ...
          <div className="relative bg-white/2 border border-white/5 rounded-2xl overflow-hidden">
            ...
            <div className="p-4 sm:p-6 font-mono text-[10px] sm:text-sm space-y-3">
              <div className="text-white/60">
                <span className="text-green-400">$</span> outray 3000 --local
              </div>
              <div className="text-white/40 pt-2 flex flex-wrap gap-x-2">
                <span>✨ Tunnel:</span>
                <span className="text-white/60 truncate">https://my-app.outray.app</span>
              </div>
              <div className="text-cyan-400 flex flex-wrap gap-x-2">
                <span>📡 Local:</span>
                <span className="text-cyan-300 truncate">https://my-app.local</span>
              </div>
            </div>
          </div>
        </div>

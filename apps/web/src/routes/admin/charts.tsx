      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="lg:col-span-2 bg-white/2 border border-white/5 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-lg font-medium text-white">Cumulative User Growth</h3>
          </div>
        ...
        <div className="bg-white/2 border border-white/5 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-lg font-medium text-white">Daily User Signups</h3>
          </div>
          <p className="text-sm text-gray-500 mb-6">New users per day (30 days)</p>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white/2 border border-white/5 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-lg font-medium text-white">Organization Growth</h3>
          </div>
          <p className="text-sm text-gray-500 mb-6">New orgs per day (30 days)</p>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white/2 border border-white/5 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-lg font-medium text-white">Weekly Tunnel Activity</h3>
          </div>
          <p className="text-sm text-gray-500 mb-6">Avg & max active tunnels (7 days)</p>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white/2 border border-white/5 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-lg font-medium text-white">24h Activity Pattern</h3>
          </div>
        ...
        <div className="bg-white/2 border border-white/5 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h3 className="text-lg font-medium text-white">Protocol Distribution</h3>
          </div>
        ...
        <div className="bg-white/2 border border-white/5 rounded-2xl p-6">
          ...
          <p className="text-sm text-gray-500 mb-6">Active vs cancelled subscriptions</p>
          <div className="h-48">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
        ...
        <div className="lg:col-span-2 bg-white/2 border border-white/5 rounded-2xl p-6">
          <div className="flex items-center gap-2 mb-2">
            <Building2 size={18} className="text-purple-400" />
            <h3 className="text-lg font-medium text-white">Top Organizations by Tunnels</h3>
          </div>
          <p className="text-sm text-gray-500 mb-6">Organizations with most tunnel usage</p>
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
